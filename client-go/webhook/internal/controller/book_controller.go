...
// +kubebuilder:rbac:groups=webapp.hxia.io,resources=books,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=webapp.hxia.io,resources=books/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=webapp.hxia.io,resources=books/finalizers,verbs=update
...
func (r *BookReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	r.Log.Info("Reconcile Book", "book", book.Name)
