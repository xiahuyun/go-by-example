...
import (
	...
	"hxia.io/book/internal/controller"
	webhookwebappv1 "hxia.io/book/internal/webhook/v1"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "e5a29a21.hxia.io",
	...
	if err = (&controller.BookReconciler{
		...
		Log:    ctrl.Log.WithName("controllers").WithName("book"),
	...
	if os.Getenv("ENABLE_WEBHOOKS") != "false" {
		if err = webhookwebappv1.SetupBookWebhookWithManager(mgr); err != nil {
